...
protected:      // subclasses can access these members
    ...
    // Total number of pages in logical memory
    int num_pages;
    // Total number of frames in physical memory
    int num_frames;
    // Array to keep track of which frames are currently free
    bool* free_frames;
    ...
    // Helper function to find next free frame
    int find_free_frame();
...
public:
     ...
     * @param page_num The logical page number.
     */
    virtual void load_page(int page_num) = 0;
